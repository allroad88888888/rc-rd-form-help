    ...
    return (dispatch,getState) => {
        ...
        return fetch(url, {
            ...
            .then((data) => {
                ...
                /*if(data&&(data.code=="200"||data.resultCode=="200")){
                    console.log("你的没有登录的干活",data);
                    dispatch(errorSave("common",data.result));
                }else{
                    dispatch(errorClear("common",data.result));
                }*/
